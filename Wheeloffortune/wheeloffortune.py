# -*- coding: utf-8 -*-
"""WHEELOFFOURTUNE.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1I7xEKBkWB1xudjJEcJkiKEb7eWdTf6gb
"""
    ...
    if self.prizeMoney < VOWEL_COST:
        ...
        for i in LETTERS:
            if i in guessed:
              ...
              possibleLetters.append(i)
    """
    for optimization use this
    for letter in LETTERS:
    if letter not in guessed:
        if letter not in VOWELS or self.prize_money >= VOWEL_COST:
